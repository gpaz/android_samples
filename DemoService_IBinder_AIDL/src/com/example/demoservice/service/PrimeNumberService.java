...
{    
    ...
    /*************************** CLASS: PrimeBinder ***************************/
    public class PrimeBinder extends IPrimeNumberGenerator.Stub
    {
        @Override
        public long[] generatePrimeNumbers(long from, long to, int count)
                throws RemoteException
        {
            return getPrimeNumbers(from, to, count);
        }
    }
